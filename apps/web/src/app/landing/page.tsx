    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-white">
      ...
      <section data-section="hero" className="max-w-6xl mx-auto px-6 pt-24 pb-20 text-center">
        ...
        <p className="mt-6 text-lg sm:text-xl text-slate-300 max-w-2xl mx-auto leading-relaxed">
          RapidDFM runs 22 manufacturability checks on every incoming ODB++ file in under 30 seconds — before your CAM team ever opens them. Reduce first-pass review time by up to 80%, standardize quoting decisions, and eliminate revision loops with customers.
        </p>
      ...
      <section data-section="stats" className="border-y border-white/10 bg-white/[0.02]">
        <div className="max-w-6xl mx-auto px-6 py-8 flex flex-wrap items-center justify-center gap-x-12 gap-y-4 text-center">
          <div>
            <div className="text-3xl font-bold text-[#4fc3f7]">22</div>
      ...
      <section data-section="problem" className="max-w-6xl mx-auto px-6 py-24">
        ...
        <div className="grid sm:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <div className="rounded-2xl border border-[#1565c0]/30 bg-[#1565c0]/5 p-6">
            ...
            <ul className="space-y-3 text-sm text-slate-300">
              <li className="flex gap-3"><Check className="h-4 w-4 text-[#4fc3f7] mt-0.5 shrink-0" />Every incoming design gets the same 22 checks in under 30 seconds. Before anyone opens a CAM tool.</li>
      ...
      <section data-section="solution" className="border-y border-white/10 bg-white/[0.02]">
        <div className="max-w-6xl mx-auto px-6 py-24 text-center">
          ...
          <p className="text-slate-400 max-w-xl mx-auto text-sm">
            RapidDFM applies your shop&apos;s capability limits — trace widths, clearances, drill sizes, annular rings, solder mask dams, plus assembly checks like component spacing and tombstoning risk — 22 checks in all — against every incoming design. No setup per job. No inconsistency between reviewers. Just upload and know.
          </p>
        </div>
      </section>
      ...
      <section id="how-it-works" data-section="how-it-works" className="max-w-6xl mx-auto px-6 py-24">
        ...
        <div className="grid sm:grid-cols-4 gap-8 text-center">
          {[
            ...
            { step: '3', title: 'Instant Analysis', desc: '22 DFM checks run in under 30 seconds. Every violation scored and mapped.' },
