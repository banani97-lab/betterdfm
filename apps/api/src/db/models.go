...
type Violation struct {
	...
	// Structured fix hint. Empty FixAction = no hint; the frontend falls
	// back to the legacy dot+ring + canned Suggestion. Mirror of
	// dfmengine.Violation FixHint fields.
